...
export const ShareDropDown = (currentImg) => {
    ...
    const socailMediaContent = [
        {
        link: "https://www.facebook.com/sharer.php?u=https://www.torisumtigerreserve.com/wp-content/uploads/2021/01/DSC2472.jpg",
        name: "Share on Facebook",
        icon: <BiLogoFacebookSquare size={15} className="mx-2"/>,
        },
        { 
        link: "https://twitter.com/i/flow/login?redirect_after_login=https://www.torisumtigerreserve.com/wp-content/uploads/2021/01/DSC2472.jpg",
        name: "Share on Twitter",
        icon: <BiLogoTwitter size={15} className="mx-2"/>,
        },
        {
        link: "https://www.pinterest.com/pin/create/button/?url=&media=https://www.torisumtigerreserve.com/wp-content/uploads/2021/01/DSC2472.jpg",
        name: "Pin it",
        icon: <BiLogoPinterest size={15} className="mx-2"/>,
        },
        {
        link: "https://www.torisumtigerreserve.com/wp-content/uploads/2021/01/DSC2472.jpg",
        name: "Download image",
