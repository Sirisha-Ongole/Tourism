...
export default function refundandCacellation() {
  ...
  const liStyle = {
    style:
      "list-decimal flex flex-col space-y-2 text-lg tracking-wide leading-loose text-gray-800 font-sans font-thin",
  };
  return (
    <>
      ...
      <div className="bg-white">
        <div
          className={`text-2xl font-bold text-center pt-20 ${whitney.className}`}
        >
        ...
        <div className="mx-auto px-20 pt-5 pb-20 w-4/5">
          <ol key={1} className={`${liStyle.style}`}>
            <li key={1}>
              Cancellation before 48 hours check-in time 50% will be deducted
              for room booking.
            </li>
            <li key={2}>
              Cancellation before 24 hours check-in time 75% will be deducted
              for room booking.
            </li>
            ...
            <li key={6}>
              Rescheduling of room booking as well as safari will not be
              allowed.
            </li>
          </ol>
        </div>
